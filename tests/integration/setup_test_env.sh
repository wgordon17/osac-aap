...
# 6. Generate integration_config.yml with safe defaults for storage tests
echo "Generating integration_config.yml..."
cat > "${SCRIPT_DIR}/integration_config.yml" <<'YAML'
---
# Auto-generated by setup_test_env.sh — safe defaults for CI.
# For live VAST API tests, copy integration_config.yml.template and fill in real values.
vast_endpoint: "https://localhost:9443"
vast_username: "ci-test"
vast_password: "ci-test"
vast_tenant_prefix: "osac-ci-"
vast_validate_certs: false
YAML

# 7. Apply storage test fixtures and CRDs (conditional)
